...
def audit_result(*, include_issue: bool = True, include_sample: bool = True) -> AuditResult:
    ...
    return AuditResult(
        summary=AuditSummary(
            ...
            png_ocr_no_text=0,
            png_ocr_failed=0,
            pdf_pages_ocr_targeted=0,
            pdf_pages_ocr_success=0,
            pdf_pages_ocr_no_text=0,
            pdf_pages_ocr_failed=0,
            ocr_regions_detected=0,
            ocr_regions_included=0,
            ocr_regions_low_confidence=0,
            ocr_characters=0,
